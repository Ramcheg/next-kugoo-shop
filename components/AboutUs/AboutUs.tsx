            ...
            <div className="container mx-auto">
                <div className="flex flex-col-reverse md:flex-row justify-between items-center gap-3">
                    ...
                    <div className="w-full px-3 md:px-0 md:w-1/2">
                        <H level={2}>
                            Kugoo-Ukraine — первый официальный дилер Kugoo Kirin
                            в Украине
                        </H>
                        <div className="mt-4 text-base">
                            Наша цель предоставить полный ассортимент
                            современной продукции Kugoo Kirin, которая улучшает
                            и упрощает жизнь. Стремимся подарить комфорт и
                            эмоции, поэтому помогаем с выбором и внимательно
                        ...
                        <div className="bg-white rounded-lg py-5 px-7 mt-9">
                            <div className="text-sm 2xl:text-base font-medium  ml-[-14px]">
                                Специализируемся исключительно на бренде Kugoo,
                                поэтому вы получите:
                            </div>
                            <ul className="list-disc list-outside mt-2 list-image-triangle text-sm 2xl:text-base">
                                ...
                                <li className="pl-2">
                                    более 1 000 запчастей и аксессуаров в
                                    наличии
                                </li>
                            </ul>
                            <Link
